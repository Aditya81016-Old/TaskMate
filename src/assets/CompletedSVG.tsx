...
export default function CompletedSVG(props: props) {
  return (
    <>
      ...
      <div className="completed-svg" style={{ transform: `scale(${props.scale}) translateY(${props.y}) translateX(${props.x})` }}>
        {/* SVG from internet */}
        <svg
        ...
        >
          ...
          <g>
            <circle cx="296.07" cy="386.91" r="68.31" fill=" rgb(252 211 77)" />
            <path
          ...
          <g>
            <polygon
              ...
              fill="#f3a3a6"
            />
            <circle cx="97.04" cy="276.06" r="16.56" fill="#f3a3a6" />
            <path
            ...
            <g>
              <path
                id="uuid-334169b2-d322-42da-b25f-a4a8dc7931c2-90"
            ...
            />
            <path
              id="uuid-9df903d1-1d84-4918-8ddd-e6aaf747ef0f-91"
